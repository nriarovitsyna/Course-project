...
Поля взяты из CSV: id, name, department, educationallevel, universityname, city,
budgetplaces, paidplaces, tuitionfee, passingscore, entrancesubjects, duration,
studyform, language, accreditation, subjectsurl, lastupdated. [file:2]
"""
